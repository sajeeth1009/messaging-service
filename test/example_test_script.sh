...
export LOGGING_SERVICE_LISTEN_PORT=5206

export MESSAGING_CONFIG_FOLDER=$PWD

export MESSAGE_SCHEDULER_INTERVAL_HIGH_PRIO=45
export MESSAGE_SCHEDULER_INTERVAL_LOW_PRIO=1800
export MESSAGE_SCHEDULER_INTERVAL_AUTO_MESSAGE=120
